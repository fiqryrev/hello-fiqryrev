# Direction: Brief Inference, Dials, Design System Map, Engineering Directives

> Source: `taste-skill` by Leonxlnx (MIT) - https://github.com/leonxlnx/taste-skill
> Reproduced with light restructuring for progressive disclosure. See ATTRIBUTION.md.

---

> **Cross-reference map.** This document was split from one upstream file. Section numbers
> referenced in the text resolve as follows:
> Sections 0-4 and 9-10 -> `references/01-direction.md` |
> Sections 5-8 -> `references/02-motion-guardrails.md` |
> Sections 11-13 -> `references/03-redesign-protocol.md` |
> Section 14 -> `references/04-preflight-checklist.md` |
> Appendices A-C -> `references/05-design-systems.md`
