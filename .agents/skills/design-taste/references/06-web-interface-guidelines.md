# Web Interface Guidelines (Review Rules)

> Source: Vercel Labs Web Interface Guidelines (MIT)
> https://github.com/vercel-labs/web-interface-guidelines
> Bundled offline copy, snapshot 2026-09-15. Fetch the source URL for the freshest rules
> when network access is available: https://raw.githubusercontent.com/vercel-labs/web-interface-guidelines/main/command.md
