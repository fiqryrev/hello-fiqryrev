...
Tracked issues discovered during Sprint 2 development/testing.

## Carried Over from Sprint 1

| ID | Description | Status | Severity |
|---|---|---|---|
| KI-002 | ChunkLoadError for splite.tsx on initial dev load | WONTFIX | Low |

_No open issues carried over from Sprint 1._
