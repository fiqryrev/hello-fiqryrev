            ...
            <div className="border-t border-white/20 pt-4 sm:pt-6">
              ...
              <Marquee className="[--duration:30s]" pauseOnHover={true}>
                {company.highlightProjects.map((project: string, index: number) => (
                  <div key={index} className="mx-2 sm:mx-4 bg-black/50 backdrop-blur-sm p-2 sm:p-3 rounded-lg border border-purple-400/20 hover:border-purple-400/40 transition-all duration-200">
        ...
        >
          <div className="text-white p-4 sm:p-8 w-full max-h-[80vh] overflow-y-auto bg-black/95 backdrop-blur-sm rounded-xl border border-purple-500/30">
            ...
            {data.events.map((event, index) => (
              <div key={index} className="mb-4 sm:mb-6 border-t border-white/20 pt-4">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="flex justify-center items-center flex-wrap mb-8 sm:mb-12 max-w-6xl mx-auto">
          {workRelatedCompanies.map((company: Company, index: number) => (
            <div key={index} className="w-1/2 sm:w-1/3 md:w-1/4 p-2">
              <div
