...
export const metadata: Metadata = {
  ...
  description: 'Build robust, scalable data infrastructure across cloud platforms with AI-powered optimization.',
};
    ...
    <div className="min-h-screen bg-black text-white">
      <div className="pt-24">
        <div className="container mx-auto px-4 py-12">
          <SolutionHeader
            badgeText="Enterprise Data Infrastructure"
            title="Data Platform Engineering"
            subtitle="Build robust, scalable data infrastructure across cloud platforms with AI-powered optimization"
          />

          <MetricsGrid items={[
            { icon: Database, value: "PB+", label: "Data Processed" },
            { icon: Zap, value: "99.9%", label: "Uptime SLA" },
            { icon: Cloud, value: "3+", label: "Cloud Platforms" },
            { icon: Settings, value: "70%", label: "Cost Reduction" },
          ]} />
          ...
          <SolutionCTA
            ...
            headline="Build Your Modern Data Platform"
            tagline="Transform your data infrastructure with enterprise-grade solutions"
            body="Whether you need cloud migration, real-time analytics, or AI-powered data services, I'll help you build a robust, scalable data platform that drives business value."
            primaryHref="/resources/contact-form"
            primaryLabel="Start Your Data Journey"
